...
function Resume() {
    ...
    return (
        <>
            ...
            <section>
                <b>Frontend:</b> HTML 5, CSS 3, JavaScript, JQuery<br />
                <b>Other Languages:</b> C++<br />
                <b>Backend:</b> MySQL, MongoDB, Express, Node.js<br />
            </section><br />
            <h4>Projects</h4>
            <b>Weather Dashboard | github.com/KDeLaria/weather-dashboard | January 11, 2024</b>
            <ul>
            ...
            <b>Code Quiz | github.com/KDeLaria/code-quiz | January 1, 2024</b>
            <ul>
